...
public class EnumerableRules {
  ...
  public static final EnumerableBestMatchRule ENUMERABLE_BEST_MATCH_RULE =
      new EnumerableBestMatchRule();

  public static final EnumerableNullifyRule ENUMERABLE_NULLIFY_RULE =
      new EnumerableNullifyRule();

  public static final EnumerableNullifyStarRule ENUMERABLE_NULLIFY_STAR_RULE =
      new EnumerableNullifyStarRule();
