...
public class JdbcImplementor extends RelToSqlConverter {
  ...
  public JdbcImplementor(SqlDialect dialect, boolean allowSubsetConvert) {
    super(dialect, allowSubsetConvert);
  }
  ...
  /** @see #dispatch */
  public Result visit(JdbcToEnumerableConverter e) {
    final RelNode input = e.getInput();
    return visitChild(0, input);
  }
