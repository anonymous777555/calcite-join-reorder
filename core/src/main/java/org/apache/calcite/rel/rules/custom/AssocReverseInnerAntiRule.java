...
/**
 * AssocReverseInnerAntiRule applies limited associativity on inner join and anti join.
 *
 * Rule 8.
 */
public class AssocReverseInnerAntiRule extends RelOptRule {
  //~ Static fields/initializers ---------------------------------------------
  private static final Logger LOGGER = CalciteTrace.getPlannerTracer();

  /** Instance of the current rule. */
  public static final AssocReverseInnerAntiRule INSTANCE = new AssocReverseInnerAntiRule(
      operand(Join.class,
  ...
  public AssocReverseInnerAntiRule(RelOptRuleOperand operand,
      String description, RelBuilderFactory relBuilderFactory) {
    super(operand, relBuilderFactory, description);
  }

  public AssocReverseInnerAntiRule(RelOptRuleOperand operand, String description) {
  ...
  @Override public void onMatch(final RelOptRuleCall call) {
    ...
    final RelNode transformedNode = call.builder().push(newTopJoin)
        .nullify(newTopJoin.getCondition(), bottomLeftList).bestMatch()
...
// End AssocReverseInnerAntiRule.java
