...
public class LogicalNullify extends Nullify {
  ...
  /**
   * Creates a LogicalNullify by parsing serialized output.
   */
  public LogicalNullify(RelInput input) {
    super(input);
    this.variablesSet = ImmutableSet.of();
  }

  /** Creates a LogicalNullify. */
  public static LogicalNullify create(final RelNode input, final RexNode condition,
      final List<? extends RexNode> attributes,
