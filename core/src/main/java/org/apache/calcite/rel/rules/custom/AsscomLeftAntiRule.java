...
/**
 * AsscomLeftAntiRule applies limited r-asscom property on left join and anti join.
 *
 * Rule 14.
 */
public class AsscomLeftAntiRule extends RelOptRule {
  //~ Static fields/initializers ---------------------------------------------
  private static final Logger LOGGER = CalciteTrace.getPlannerTracer();

  /** Instance of the current rule. */
  public static final AsscomLeftAntiRule INSTANCE = new AsscomLeftAntiRule(
      operand(Join.class,
  ...
  public AsscomLeftAntiRule(RelOptRuleOperand operand,
      String description, RelBuilderFactory relBuilderFactory) {
    super(operand, relBuilderFactory, description);
  }

  public AsscomLeftAntiRule(RelOptRuleOperand operand, String description) {
