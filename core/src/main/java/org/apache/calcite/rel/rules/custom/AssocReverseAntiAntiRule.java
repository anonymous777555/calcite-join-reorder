...
/**
 * AssocReverseAntiAntiRule applies limited associativity on anti join and anti join.
 *
 * Rule 9.
 */
public class AssocReverseAntiAntiRule extends RelOptRule {
  //~ Static fields/initializers ---------------------------------------------
  private static final Logger LOGGER = CalciteTrace.getPlannerTracer();

  /** Instance of the current rule. */
  public static final AssocReverseAntiAntiRule INSTANCE = new AssocReverseAntiAntiRule(
      operand(Join.class,
  ...
  public AssocReverseAntiAntiRule(RelOptRuleOperand operand,
      String description, RelBuilderFactory relBuilderFactory) {
    super(operand, relBuilderFactory, description);
  }

  public AssocReverseAntiAntiRule(RelOptRuleOperand operand, String description) {
...
// End AssocReverseAntiAntiRule.java
