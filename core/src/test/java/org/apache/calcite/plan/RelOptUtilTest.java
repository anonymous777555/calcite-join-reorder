...
public class RelOptUtilTest {
  ...
  @Test public void testContainsClass() {
    boolean result = RelOptUtil.containsClass(empScan, TableScan.class);
    assertTrue(result);
    result = RelOptUtil.containsClass(empScan, Filter.class);
    assertFalse(result);

    final RelNode join = relBuilder.scan("EMP").scan("DEPT")
        .join(JoinRelType.INNER, "DEPTNO")
        .build();
    result = RelOptUtil.containsClass(join, TableScan.class);
    assertTrue(result);
    result = RelOptUtil.containsClass(join, Join.class);
    assertTrue(result);
  }
}
